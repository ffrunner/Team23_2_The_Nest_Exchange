...
class Listings(db.Model):
    ...
    lister_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=False) #Added lister id
    item_id = db.Column(db.Integer, db.ForeignKey('items.id'), nullable=False) #Added item id
    items = db.relationship('Items', backref='listings')
...
class ListingPhotos(db.Model):
    ...
    Listings = db.relationship('Items', backref='listing_photos')
